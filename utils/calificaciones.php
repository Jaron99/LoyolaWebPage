...
<div class="tab-pane fade <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'calificaciones') ? 'show active' : ''; ?>" id="vista-calificaciones">
    ...
    <div class="accordion shadow-sm" id="acordeonGrados" style="border-radius: 12px; overflow: hidden;">
        <?php if (!empty($gradosAsignados)): ?>
            <?php foreach ($gradosAsignados as $grado): ?>
                
                <div class="accordion-item border-0 border-bottom">
                    <h2 class="accordion-header" id="heading_<?php echo $grado['id_grado']; ?>">
                        <button class="accordion-button collapsed fw-bold fs-5 text-dark bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_<?php echo $grado['id_grado']; ?>" aria-expanded="false">
                    ...
                    <div id="collapse_<?php echo $grado['id_grado']; ?>" class="accordion-collapse collapse" data-bs-parent="#acordeonGrados">
